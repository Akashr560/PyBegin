...
export const PROJECTS: Project[] = [
  ...
  { id: "student-attendance-analyzer", name: "Student Attendance Analyzer", cat: "tools", blurb: "Calculate attendance %, absent days & exam eligibility.", lines: 121, deps: "stdlib", emoji: "🎓", author: "Akash", repoPath: "Student-Attendance-Analyzer", playground: true },
  { id: "student-grade-calculator", name: "Student Grade Calculator", cat: "tools", blurb: "Calculate total, average, letter grade, pass/fail & statistics.", lines: 125, deps: "stdlib", emoji: "📝", author: "Akash", repoPath: "Student-Grade-Calculator", playground: true },
  { id: "student-cgpa-calculator", name: "Student CGPA Calculator", cat: "tools", blurb: "Calculate weighted CGPA, total credits & performance.", lines: 130, deps: "stdlib", emoji: "🏆", author: "Akash", repoPath: "Student-CGPA-Calculator", playground: true },
];

export const CATEGORIES: Category[] = [
  { id: "all", name: "All", count: 15 },
  { id: "games", name: "Games", count: 5 },
  { id: "tools", name: "Tools", count: 7 },
